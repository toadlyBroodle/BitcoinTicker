...
internal fun updateAllWidgets(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
    ...
    val prefPrice = prefs?.getString(CURR_PRICE, context.getString(R.string.dash))
    val prefDayVolume = prefs?.getString(CURR_DAY_VOLUME, context.getString(R.string.dash))
    val prefMarketCap = prefs?.getString(CURR_MARKET_CAP, context.getString(R.string.dash))
    val prefLastUpdate = prefs?.getString(CURR_LAST_UPDATE, context.getString(R.string.dash))
    ...
    views.apply {
        ...
        setTextViewText(R.id.widget_textview_price_delta_day_value, prefPriceDeltaDay?.let { formatAsChangePercent(it) })
        setTextViewText(R.id.widget_textview_price_delta_week_value, prefPriceDeltaWeek?.let { formatAsChangePercent(it) })
        setTextViewText(R.id.widget_textview_price_delta_month_value, prefPriceDeltaMonth?.let { formatAsChangePercent(it) })
        setTextViewText(R.id.widget_textview_market_cap_delta_day_value, prefMarketCapDeltaDay?.let { formatAsChangePercent(it) })
        setTextViewText(R.id.widget_textview_market_cap_delta_week_value, prefMarketCapDeltaWeek?.let { formatAsChangePercent(it) })
        setTextViewText(R.id.widget_textview_market_cap_delta_month_value, prefMarketCapDeltaMonth?.let { formatAsChangePercent(it) })
        setTextViewText(R.id.widget_textview_volume_delta_day_value, prefVolumeDeltaDay?.let { formatAsChangePercent(it) })
        setTextViewText(R.id.widget_textview_volume_delta_week_value, prefVolumeDeltaWeek?.let { formatAsChangePercent(it) })
        setTextViewText(R.id.widget_textview_volume_delta_month_value, prefVolumeDeltaMonth?.let { formatAsChangePercent(it) })
/*
